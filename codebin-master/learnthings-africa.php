      ...
      <div class="page-title-large5-cont bg-gray">
        <div class="container relative">
          <div class="page-title-large5-text-cont">
            <div>
              <h1 class="page-title5">LearnThings Africa (Samsung)</h1>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="port-detail-cont mb-30">
                ...
                <div class="port-detail font-poppins mb-20">
                  <p>
                    ...
                    LearnThings Africa (Samsung)
                  </p>
                  <p>
                    <strong class="font-black">Products:</strong>
                    E-learning content upload platform
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    Android, JAVA, ionic platform, Adobe Flash
                  </p>
              ...
              <div class="lightbox-item popup-gallery">
                <a href="images/img/products/single/LearnThingsAfrica.jpg">
                  <div class="port-img-overlay">
                    <img class="port-main-img" src="images/img/products/single/LearnThingsAfrica.jpg" alt="img">
                  </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="work-navigation plr-10 clearfix">
              ...
              <a href="semblence.php" class="work-next"><span>Next&nbsp;<span class="icon icon-arrows-right"></span></span></a>
            </div>
          </div>
        </div>
