      ...
      <div class="page-title-large5-cont bg-gray">
        <div class="container relative">
          <div class="page-title-large5-text-cont">
            <div>
              <h1 class="page-title5">Shoppingpost</h1>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
              ...
              <div class="port-detail-cont mb-30">
                ...
                <div class="port-detail font-poppins mb-20">
                  ...
                  <p>
                    ...
                    A full fledged Social network for shoppers
                  </p>
                  <p>
                    <strong class="font-black">Skills:</strong>
                    ReactJs, React Native, MongoDb, AWS Lambda, RDS, CloudFront, Firebase, Restful API
                  </p>
                  <p>
                    <strong class="font-black">Link:</strong>
                    <a href="http://shoppingpost.in/" target="_blank">shoppingpost.in</a>
                  </p>
                </div>
            ...
            <div class="col-sm-8 col-md-8 col-md-offset-1 mb-50">
              <div class="lightbox-item popup-gallery">
                <a href="images/img/products/single/Shoppingpost.jpg">
                  <div class="port-img-overlay">
                    <img class="port-main-img" src="images/img/products/single/Shoppingpost.jpg" alt="img">
                  </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="work-navigation plr-10 clearfix">
              <a class="work-prev" style="color:gray;"><span><span class="icon icon-arrows-left"></span>&nbsp;Prev</span></a>
              <a href="./#portfolio" class="work-all"><span>All</span></a>
              <a href="disney-london.php" class="work-next"><span>Next&nbsp;<span class="icon icon-arrows-right"></span></span></a>
            </div>
          </div>
        </div>
