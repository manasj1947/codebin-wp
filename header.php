...
<head>
  <title>CodeBin - Invasion Software Technologies Pvt Ltd</title>
  <meta charset="<?php bloginfo( 'charset' ); ?>">
  <meta name="google-site-verification" content="YLX-fi-HbqYhQ-00iO7wAQ0PqcAWAOYw-JnKJAkaMbE" />
  <!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
  <meta name="robots" content="index, follow">
  <meta name="keywords"
    content="Software development, ReactJs, React native, Mobile app development, software development in India">
  <meta name="description"
    content="CodeBin is a software and mobile development company. We work on ReactJs, React Native, Android and iOS applications, Progressive web apps and scalable enterprise applications">
  <meta name="author" content="Nitin Singh Solanky">
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
  <meta name="theme-color" content="#005756">

  <!-- FAVICONS -->
  <link rel="shortcut icon" href="<?php echo SITE_URL; ?>/images/favicon/favicon.png">
  <link rel="apple-touch-icon" href="<?php echo SITE_URL; ?>/images/favicon/apple-touch-icon-72x72.png">
  <link rel="apple-touch-icon" sizes="72x72" href="<?php echo SITE_URL; ?>/images/favicon/apple-touch-icon-72x72.png">
  <link rel="apple-touch-icon" sizes="114x114"
    href="<?php echo SITE_URL; ?>/images/favicon/apple-touch-icon-114x114.png">
  <link rel="icon" sizes="192x192" href="<?php echo SITE_URL; ?>/images/favicon/icon-192x192.png">
  ...
  <link href="<?php echo SITE_URL; ?>/revo-slider/css/settings.css" rel="stylesheet" type="text/css">

  <!--  BOOTSTRAP -->
  <link rel="stylesheet" href="<?php echo SITE_URL; ?>/css/bootstrap.min.css">

  <!-- ICONS ELEGANT FONT & FONT AWESOME & LINEA ICONS  -->
  <link rel="stylesheet" href="<?php echo SITE_URL; ?>/css/icons-fonts.css">
  ...
  <!-- IE Warning CSS -->
  <!--[if lte IE 8]><link rel="stylesheet" type="text/css" href="<?php echo SITE_URL; ?>/css/ie-warning.css" ><![endif]-->
  <!--[if lte IE 8]><link rel="stylesheet" type="text/css" href="<?php echo SITE_URL; ?>/css/ie8-fix.css" ><![endif]-->
  ...
  <div id="wrap" class="boxed ">
    <div class="grey-bg">
      ...
      <header id="nav" class="header header-1 affix-on-mobile">
        <div class="header-wrapper bg-semi-white">
          <div class="container-m-30 clearfix">
            <div class="logo-row">
              ...
              <div class="menu-btn-respons-container">
                <button id="menu-btn" type="button" class="navbar-toggle btn-navbar collapsed" data-toggle="collapse"
